...
<div id="main_content">
    ...
    <div id="header_top" class="header_top">
        <div class="container">
            ...
            <div class="hright">
                <div class="dropdown">
                    <a href="javascript:void(0)" class="nav-link icon settingbar"><i class="fa fa-gear fa-spin" data-toggle="tooltip" data-placement="right" title=Ayarlar></i></a>
    ...
    <div class="user_div">
        <h5 class="brand-name mb-4">TU-MANİ<a href="javascript:void(0)" class="user_btn"><i class="icon-logout"></i></a></h5>
            ...
            <div class="container-fluid">
                <div class="page-header">
                    <div class="left">
                        ...
                        <h1 class="page-title">Site Üyeleri</h1>                        
                    </div>
                    <div class="right">
                            ...
                            <div class="card-body">
                                <div class="d-md-flex justify-content-between">
                                    <ul class="nav nav-tabs b-none">
                                        <li class="nav-item"><a class="nav-link active" id="list-tab" data-toggle="tab" href="#list"><i class="fa fa-list-ul"></i> Liste</a></li>
                                       
                                        <li class="nav-item"><a class="nav-link" id="addnew-tab" data-toggle="tab" href="#addnew"><i class="fa fa-plus"></i> Yeni Ekle</a></li>
                                    </ul>
                                    ...
                                    <table class="table table-hover table-vcenter text-nowrap table_custom border-style list">
                                        <tbody>
                                            <tr class="">
                                                ...
                                                <td class="text-right">
                                                    <a class="btn btn-sm btn-link" href="javascript:void(0)" data-toggle="tooltip" title="Telefon"><i class="fa fa-phone"></i></a>
                                                    <a class="btn btn-sm btn-link" href="javascript:void(0)" data-toggle="tooltip" title="Mail Adresi"><i class="fa fa-envelope"></i></a>
                                                    <a class="btn btn-sm btn-link hidden-xs js-sweetalert" data-type="confirm" href="javascript:void(0)" data-toggle="tooltip" title="Sil"><i class="fa fa-trash"></i></a>
                                                </td>
                                            </tr>
                                            <tr class="">
                                                <td class="width35 hidden-xs">
                                    ...
                                    <div class="card-body">
                                        <div class="row clearfix">
                                            <div class="col-lg-4 col-md-12">
                                                <div class="form-group">
                                                    <input type="text" class="form-control" placeholder="Adı Girin">
                                                </div>
                                            </div>
                                            <div class="col-lg-4 col-md-12">
                                                <div class="form-group">
                                                    <input type="number" class="form-control" placeholder="Numarayı Girin">
                                                </div>
                                            </div>
                                            <div class="col-lg-4 col-md-12">
                                                <div class="form-group">
                                            ...
                                            <div class="col-lg-12 col-md-12">
                                                <div class="form-group">
                                                    <textarea type="text" class="form-control" rows="4">Adresinizi girin</textarea>
                                                </div>
                                            </div>
                                            <div class="col-lg-12">
